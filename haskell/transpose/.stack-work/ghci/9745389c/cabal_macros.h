...
/* package transpose-1.1.0.2 */
#ifndef VERSION_transpose
#define VERSION_transpose "1.1.0.2"
#endif /* VERSION_transpose */
#ifndef MIN_VERSION_transpose
#define MIN_VERSION_transpose(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_transpose */
...
#define CURRENT_PACKAGE_KEY "transpose-1.1.0.2-8WvTrGuKtjMKHuH7A6Ccv3"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "transpose-1.1.0.2-8WvTrGuKtjMKHuH7A6Ccv3"
