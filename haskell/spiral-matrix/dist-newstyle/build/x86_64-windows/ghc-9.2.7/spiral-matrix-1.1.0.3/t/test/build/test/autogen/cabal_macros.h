...
/* package spiral-matrix-1.1.0.3 */
#ifndef VERSION_spiral_matrix
#define VERSION_spiral_matrix "1.1.0.3"
#endif /* VERSION_spiral_matrix */
#ifndef MIN_VERSION_spiral_matrix
#define MIN_VERSION_spiral_matrix(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_spiral_matrix */
...
#define CURRENT_COMPONENT_ID "spiral-matrix-1.1.0.3-inplace-test"
